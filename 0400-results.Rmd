...
fpr::fpr_make_tab_cv(dat = pscis_phase2) %>% 
  fpr::fpr_kable(caption_text = 'Summary of Phase 2 fish passage reassessments.')
```
...
tab_cost_est_phase2_report %>% 
  fpr::fpr_kable(caption_text = 'Cost benefit analysis for Phase 2 assessments.')
...
tab_hab_summary %>% 
  ...
  fpr::fpr_kable(caption_text = 'Summary of Phase 2 habitat confirmation details.')
