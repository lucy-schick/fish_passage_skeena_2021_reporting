...
tab_overview %>% 
  select(-Tenure) %>%
  fpr::fpr_kable(caption_text = 'Overview of habitat confirmation sites.', scroll = gitbook_on)
...
tab_cost_est_phase2_report %>% 
  fpr::fpr_kable(caption_text = 'Cost benefit analysis for Phase 2 assessments.', scroll = gitbook_on)
