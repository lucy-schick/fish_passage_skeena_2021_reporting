...
tab_overview %>% 
  select(-Tenure) %>%
  fpr::fpr_kable(caption_text = 'Overview of habitat confirmation sites. Coho rearing model used for habitat estimates (total length of stream segments <7.5% gradient)', scroll = gitbook_on)
