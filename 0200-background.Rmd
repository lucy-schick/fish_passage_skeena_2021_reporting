...
```{r hydrology-plot, fig.cap = 'Hydrograph for Bulkley River at Quick (Station #08EE004).', eval=T}
...
```{r hydrology-plotb, fig.cap = 'Hydrograph for Upper Bulkley River (upstream of confluence with Morice River) near Houston (Station #08EE003).', eval=T}
...
```{r hydrology-plot-old, fig.cap = 'Hydrograph for Bulkley River at Quick (Station #08EE004) and near Houston (Station #08EE003).', fig.show="hold", out.width= c("49.5%","1%","49.5%"), eval=F}
...
```{r hydrology-stats1, fig.cap = 'Summary of hydrology statistics for Bulkley River at Quick (Station #08EE004 - daily discharge data from 1930 to 2018).', eval=F}
knitr::include_graphics("fig/hydrology_stats_08EE004.png")
```

```{r hydrology-stats2, fig.cap = 'Summary of hydrology statistics for Bulkley River near Houston (Station #08EE003 - daily discharge data from 1980 to 2018).', eval=F}
...
```{r hydrology-plot2, fig.cap = 'Hydrograph for Morice River near outlet of Morice Lake (Station #08ED002).', eval=T}
...
```{r hydrology-plot2-old, fig.cap = 'Left: Hydrograph for Morice River near Houston (Station #08ED003 - 1971 data only). Right: Hydrograph for Morice River near outlet of Morice Lake (Station #08ED002).', fig.show="hold", out.width= c("49.5%","1%","49.5%"), eval=F}
...
```{r hydrology-stats3, fig.cap = 'Summary of hydrology statistics for Morice River near outlet of Morice Lake (Station #08ED002 - Lat 54.116829 Lon -127.426582). Available daily discharge data from 1961 to 2018.', eval=F}
