...
fpr::fpr_table_bcfp() %>% 
  fpr::fpr_kable(caption_text = paste0('Summary of fish habitat modelling for PSCIS crossing ', my_site, '. Note that modelling data is imprecise as mapped location of Thompson Creek mainstem differs from location in the field.'),
