...
The Office of Wet'suwet'en has initiated watershed-level Nation-led recovery and restoration planning for the greater Bii Wenii Kwa (Owen Creek) watershed, which includes restoration of this site as a project priority. As the Yinka Dene Economic Development Limited Partnership is noted as the road tenure holder at the location of the site, there may be opportunities for collaboration between the two groups on the restoration or removal of the crossing. Additionally, Klate Lake Road provides access to Nadina Mountain Provincial Park, which features the [Nadina Mountain Trail](https://www.trailforks.com/trails/nadina-mountain-trail/) leading to scenic alpine spires. This recreational trail presents an opportunity to connect people to the land and foster community engagement and stewardship that can further support restoration efforts. Crossing `r as.character(my_site)` was ranked as a `r fpr::fpr_my_priority_info(col_pull = priority)` priority for proceeding to design for replacement.
